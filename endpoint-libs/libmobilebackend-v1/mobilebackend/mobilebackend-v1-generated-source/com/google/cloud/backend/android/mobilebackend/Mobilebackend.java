...
public class Mobilebackend extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.18.0-rc of the mobilebackend library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://spring-ember-643.appspot.com/_ah/api/";
  ...
  public class BlobEndpoint {
     ...
     *
     * This request holds the parameters needed by the mobilebackend server.  After setting any optional
     * parameters, call the {@link DeleteBlob#execute()} method to invoke the remote operation.
     *
     * @param bucketName
     * @param objectPath
     * @return the request
     ...
     *
     * This request holds the parameters needed by the mobilebackend server.  After setting any optional
     * parameters, call the {@link GetDownloadUrl#execute()} method to invoke the remote operation.
     *
     * @param bucketName
     * @param objectPath
     * @return the request
  ...
  public class EndpointV1 {
     ...
     *
     * This request holds the parameters needed by the mobilebackend server.  After setting any optional
     * parameters, call the {@link UpdateAll#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.google.cloud.backend.android.mobilebackend.model.EntityListDto}
     * @return the request
     */
